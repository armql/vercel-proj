            ...
            {!theme ? (
                ...
                >
                    ...
                    <div className="flex w-full flex-col items-center justify-center gap-4 py-4">
                        ...
                        <div
                            className="flex hidden h-10 flex-row items-center justify-center gap-2 transition ease-in-out group-hover:block">
                            <div className="flex flex-row items-center justify-center gap-1">
                                ...
                                />
                                <Star size={20} weight="fill"
                                      className={`h-5 w-5 ${averageRating >= 2 ? "text-green-300" : "text-zinc-300"}`}
                                />
                                <Star size={20} weight="fill"
                                      className={`h-5 w-5 ${averageRating >= 3 ? "text-green-300" : "text-zinc-300"}`}
                                />
                                <Star size={20} weight="fill"
                                      className={`h-5 w-5 ${averageRating >= 4 ? "text-green-300" : "text-zinc-300"}`}
                                />
                                <Star size={20} weight="fill"
                                      className={`h-5 w-5 ${averageRating >= 5 ? "text-green-300" : "text-zinc-300"}`}
                                />
                ...
                >
                    ...
                    <img
                        ...
                        alt="Card Shapes"
                        className={`absolute bottom-0 brightness-90 ${response.label === "Avocado Ranch" || response.label === "Balsamic" ? "" : "top-0"}`}
                    />
                    <div
                        className="flex h-full w-full z-10 flex-col items-center justify-between gap-4 px-12 py-14 text-center">
                    ...
                    <div className="flex w-full flex-row items-center justify-center gap-2 pb-6 pt-4 font-mono text-xs">
                        ...
                        >
                            In store
                            <div
                                className="absolute bottom-0 left-0 right-0 top-0 -z-10 h-0 w-full bg-white transition-all duration-300 group-hover:h-full"/>
                        </button>
                        <button
                            type="button"
