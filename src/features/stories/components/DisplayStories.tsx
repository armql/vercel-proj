...
export default function DisplayStories() {
  ...
  const { data: news, isLoading: isLoadingRecipes } = useQuery(
    ["news", patriarch, selectedTab, searchTerm],
    () => fetchNews(patriarch, ancestor),
    {
